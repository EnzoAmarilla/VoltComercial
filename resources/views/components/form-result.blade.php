        ...
        <div class="modal-content">
            ...
            @if(session('status') == 200)
                <div class="div-bg-form-contact border-none">
                    <h6 class="text-title-tv text-center">Thank you<span class="blue-dot"> !</span></h6>
                    <p class="title-hero-grey mt-4">We'll be reaching out to you soon.</p>
                </div>                
            @else
                <div class="div-bg-form-contact border-none">
                    <h6 class="text-title-tv text-center">Something Went Wrong<span class="blue-dot"> !</span></h6>
