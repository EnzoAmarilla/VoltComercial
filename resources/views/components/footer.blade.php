        ...
        <div class="container-fluid">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-4 col-md-12 text-center text-md-left footer-padding">
                    <h4 class="title-footer-2 white-space">{{ $text_title_footer }}</h4>
                    <div class="horizontal-bar"></div>
                    <h3 class="title-footer-2">@lang('translations.Reach'):</h3>
                ...
                <div class="col-lg-7 col-md-12 vw-100 text-center text-md-right d-none-sm d-none-md">
                    <img data-src="{{ asset('images/Footer/image-footer.png') }}" alt="" class="img-padding lazyload">
                </div>
            </div><!-- end row -->
        </div><!-- end container -->
    </div>
